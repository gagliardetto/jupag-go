...
// SaberAddDecimalsWithdraw is the `saberAddDecimalsWithdraw` instruction.
type SaberAddDecimalsWithdraw struct {
...
// NewSaberAddDecimalsWithdrawInstructionBuilder creates a new `SaberAddDecimalsWithdraw` instruction builder.
func NewSaberAddDecimalsWithdrawInstructionBuilder() *SaberAddDecimalsWithdraw {
	nd := &SaberAddDecimalsWithdraw{
...
func (inst *SaberAddDecimalsWithdraw) SetInAmount(inAmount uint64) *SaberAddDecimalsWithdraw {
	inst.InAmount = &inAmount
	return inst
}

// SetMinimumOutAmount sets the "minimumOutAmount" parameter.
func (inst *SaberAddDecimalsWithdraw) SetMinimumOutAmount(minimumOutAmount uint64) *SaberAddDecimalsWithdraw {
	inst.MinimumOutAmount = &minimumOutAmount
	return inst
}

// SetPlatformFeeBps sets the "platformFeeBps" parameter.
func (inst *SaberAddDecimalsWithdraw) SetPlatformFeeBps(platformFeeBps uint8) *SaberAddDecimalsWithdraw {
	inst.PlatformFeeBps = &platformFeeBps
	return inst
}

// SetAddDecimalsProgramAccount sets the "addDecimalsProgram" account.
func (inst *SaberAddDecimalsWithdraw) SetAddDecimalsProgramAccount(addDecimalsProgram ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
...
func (inst *SaberAddDecimalsWithdraw) GetAddDecimalsProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetWrapperAccount sets the "wrapper" account.
func (inst *SaberAddDecimalsWithdraw) SetWrapperAccount(wrapper ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(wrapper)
	return inst
}

// GetWrapperAccount gets the "wrapper" account.
func (inst *SaberAddDecimalsWithdraw) GetWrapperAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetWrapperMintAccount sets the "wrapperMint" account.
func (inst *SaberAddDecimalsWithdraw) SetWrapperMintAccount(wrapperMint ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(wrapperMint).WRITE()
	return inst
}

// GetWrapperMintAccount gets the "wrapperMint" account.
func (inst *SaberAddDecimalsWithdraw) GetWrapperMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetWrapperUnderlyingTokensAccount sets the "wrapperUnderlyingTokens" account.
func (inst *SaberAddDecimalsWithdraw) SetWrapperUnderlyingTokensAccount(wrapperUnderlyingTokens ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
...
func (inst *SaberAddDecimalsWithdraw) GetWrapperUnderlyingTokensAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetOwnerAccount sets the "owner" account.
func (inst *SaberAddDecimalsWithdraw) SetOwnerAccount(owner ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(owner).SIGNER()
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *SaberAddDecimalsWithdraw) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetUserUnderlyingTokensAccount sets the "userUnderlyingTokens" account.
func (inst *SaberAddDecimalsWithdraw) SetUserUnderlyingTokensAccount(userUnderlyingTokens ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
...
func (inst *SaberAddDecimalsWithdraw) GetUserUnderlyingTokensAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetUserWrappedTokensAccount sets the "userWrappedTokens" account.
func (inst *SaberAddDecimalsWithdraw) SetUserWrappedTokensAccount(userWrappedTokens ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
...
func (inst *SaberAddDecimalsWithdraw) GetUserWrappedTokensAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *SaberAddDecimalsWithdraw) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *SaberAddDecimalsWithdraw) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

func (inst SaberAddDecimalsWithdraw) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_SaberAddDecimalsWithdraw,
	}}
}
...
func (inst SaberAddDecimalsWithdraw) ValidateAndBuild() (*Instruction, error) {
...
func (inst *SaberAddDecimalsWithdraw) Validate() error {
...
func (inst *SaberAddDecimalsWithdraw) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("SaberAddDecimalsWithdraw")).
				//
...
func (obj SaberAddDecimalsWithdraw) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *SaberAddDecimalsWithdraw) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
// NewSaberAddDecimalsWithdrawInstruction declares a new SaberAddDecimalsWithdraw instruction with the provided parameters and accounts.
func NewSaberAddDecimalsWithdrawInstruction(
	// Parameters:
	inAmount uint64,
	minimumOutAmount uint64,
	platformFeeBps uint8,
	...
	tokenProgram ag_solanago.PublicKey) *SaberAddDecimalsWithdraw {
	return NewSaberAddDecimalsWithdrawInstructionBuilder().
